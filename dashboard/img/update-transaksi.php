...
$sql = "UPDATE transaksi SET id_transaksi='$id_transaksi', id_pesan='$id_pesan', foto='$foto' WHERE id_transaksi='$id_transaksi' LIMIT 1";
$hasil = mysqli_query($kon, $sql);
$sql2 = "INSERT INTO tiket (id_transaksi) VALUES ('$_POST[id_transaksi]') ";
// echo $sql2;
// die;
