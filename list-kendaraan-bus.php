...
<head>
    ...
    <!-- Title -->
    <title>Daftar Kendaraan Bus</title>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading dark text-center">
                        <span></span>
                        <h4>Daftar Bus Budiman</h4>
                        <p>Berikut daftar bus budiman.</p><br/>
...
$query = mysqli_query($kon, "select * from kendaraan order by id_kendaraan") or die("Gagal query");
					...
					<img src="img/bus1.jpg" alt="" width="500" height="500">
                        ...
                        <div class="feature-content d-flex align-items-center justify-content-between">
                            <div class="feature-title">
                                <h5><?= $r['merek_kendaraan']; ?></h5>
                                <p>Nomor Polisi: <?= $r['nomor_kendaraan']; ?><br/>
								Kelas Kendaraan: <?= $r['kelas_kendaraan']; ?><br/>
								</p>
								<div class="feature-favourite">
                                <a href="#"><?= rupiah($r['harga_kelas']); ?></a>
								</div>
								<p><small>*<i>Belum termasuk harga tujuan.</i></small></p>
                            </div>
                        </div>
                    </div>
                </div>
